...
cursor.execute('''
INSERT OR IGNORE INTO YearGroup(name, display) VALUES('Year 6', 0), ('Year 7', 1), ('Year 8', 1), ('Year 9', 1), ('Year 10', 1), ('Year 11', 1),('Year 12', 1)
''')

cursor.execute('''
INSERT OR IGNORE INTO Subject(name, display) VALUES('Art', 1), ('Computing', 1), ('Design and Technology', 1), ('English', 0), ('French', 1),('Geography', 1),('History', 1),('Maths', 1),('Media Studies', 1)
''')
...
# Helper functions
def fetch_subjects():
    cursor.execute("SELECT id, name FROM Subject WHERE display == 1")
    return cursor.fetchall()

def fetch_year_groups():
    cursor.execute("SELECT id, name FROM YearGroup WHERE display == 1")
    return cursor.fetchall()
